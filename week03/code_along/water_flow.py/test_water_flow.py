# This program calculates water pressure in a distribution system.
#1. Defined constants for gravity, water density, and dynamic viscosity.
#2. Added a function to convert kilopascals to pounds per square inch (psi).
#3. Added a test for the conversion function in the test file.
...
def test_kpa_to_psi():
    # Extra test for exceeding requirements
    assert kpa_to_psi(0) == approx(0)
    assert kpa_to_psi(158.7) == approx(23.01, abs=0.01)
